...
# construção e treinamento do modelo multiclasse
...
# construção e treinamento do modelo binário
# filtra os dados para obter apenas as classes escolhidas para a tarefa binária (0 e 1)
class_1, class_2 = 0, 1
...
# treina e avalia o modelo binário
